...
#include "../Client05/documentwidget.h"
...
QT_MOC_LITERAL(1, 15, 14), // "documentLoaded"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 18), // "documentLoadFailed"
QT_MOC_LITERAL(4, 50, 12) // "documentLoad"

    },
    "DocumentWidget\0documentLoaded\0\0"
    "documentLoadFailed\0documentLoad"
};
...
void DocumentWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->documentLoadFailed(); break;
        case 2: _t->documentLoad(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DocumentWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DocumentWidget::documentLoaded)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DocumentWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DocumentWidget::documentLoadFailed)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DocumentWidget::documentLoaded()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void DocumentWidget::documentLoadFailed()
{
